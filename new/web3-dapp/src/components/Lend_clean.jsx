// filepath: /Users/rajatsharma/Desktop/Hackathon/new/web3-dapp/src/components/Lend.jsx
...
const Lend = () => {
  ...
  const hasEnoughBalance = balance ? depositAmountBigInt <= balance : false
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="flex flex-col justify-end">
                <button
                  ...
                  disabled={!isValidAmount || !hasEnoughBalance || isDepositing || isConfirming}
                ...
                {isConfirmed && (
                  <p className="text-accent-success text-sm mt-2">Deposit successful!</p>
                )}
              </div>
            </div>
          </div>
